...
summon area_effect_cloud ^1 ^ ^ {Tags:["axis_v2"],Duration:1}
...
execute store result score @s ax2 run data get entity @e[tag=axis_v2,limit=1] Pos[0] 1000
execute store result score @s Tmp run data get entity @s Pos[0] 1000
scoreboard players operation @s ax2 -= @s Tmp
execute store result score @s ay2 run data get entity @e[tag=axis_v2,limit=1] Pos[1] 1000
execute store result score @s Tmp run data get entity @s Pos[1] 1000
scoreboard players operation @s ay2 -= @s Tmp
execute store result score @s az2 run data get entity @e[tag=axis_v2,limit=1] Pos[2] 1000
execute store result score @s Tmp run data get entity @s Pos[2] 1000
...
##標記初根箭矢
execute positioned ~ ~1.6 ~ run data modify entity @e[type=arrow,sort=nearest,limit=1] Tags set value ["1st", "multiarrow"]
