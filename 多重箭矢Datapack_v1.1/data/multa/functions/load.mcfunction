...
# 載入完成輸出
tellraw @a [{"text":" [多重箭矢] ","color":"gold"},{"text":" 已成功載入！ 輸入 ","color":"white"},{"text":"\" /function multa:cmd/info \" ","color":"white"},{"text":"可了解詳情   (by Guizhi)","color":"white"}]
